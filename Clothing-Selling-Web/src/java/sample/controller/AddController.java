...
public class AddController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int cmbQuantity = Integer.parseInt(request.getParameter("cmbQuantity"));
            int tmpQuan = 0;
            ...
            if (session != null) {
                ...
                for (Product prod : list) {
                    if (prod.getProID().equals(cmbProduct)) {
                        Product pro = new Product(cmbProduct, prod.getProName(), cmbQuantity, prod.getPrice(),true);
                        check = cart.add(cmbProduct, pro);
                        break;
                    }
